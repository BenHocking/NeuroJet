...
ParallelRand::ParallelRand(float p, int seed, int rng_max_available,
                           int rng_max_gen)
  : m_p(p), m_rng_available(0), m_rng_max_available(rng_max_available),
    m_rng_next_available(0), m_rng_max_gen(rng_max_gen),
    m_rng_double_bucket(NULL) {
...
ParallelRand::ParallelRand(double low, double high, int seed,
                           ...
                           int rng_max_gen)
  : m_low(low), m_high(high), m_rng_available(0),
    m_rng_max_available(rng_max_available), m_rng_next_available(0),
    m_rng_max_gen(rng_max_gen), m_rng_bool_bucket(NULL) {
