...
public:
   ...
   static void AddSavedFile(string, string);
   ...
   static DataMatrix getData(const std::string &SeqName,
                   const std::string &FunctionName, const CommandLine &ComL);
   inline static DataMatrix getData(const TArg<string> &SeqName,
                   const std::string &FunctionName, const CommandLine &ComL) {
   ...
   static DataMatrix getMatrix(const std::string &SeqName,
                   const std::string &FunctionName, const CommandLine &ComL);
   inline static DataMatrix getMatrix(const TArg<string> &SeqName,
                   const std::string &FunctionName, const CommandLine &ComL) {
   ...
   static UIPtnSequence getSequence(const std::string &SeqName,
                   const std::string &FunctionName, const CommandLine &ComL);
   inline static UIPtnSequence getSequence(const TArg<string> &SeqName,
                   const std::string &FunctionName, const CommandLine &ComL) {
   ...
   inline static char GetVarType(const TArg<string> &s) {
   ...
   inline static void insertData(const TArg<string> &insertName,
                   const DataMatrix &toInsert, const DataListType insertType) {
   ...
   inline static void insertSequence(const TArg<string> &seqName, const UIPtnSequence &toInsert) {
